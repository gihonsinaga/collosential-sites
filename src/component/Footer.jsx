...
const navigation = {
  ...
  legal: [
    { name: "+62 897-1804-701", href: "#" },
    { name: "collos.sentials@gmail.com", href: "#" },
    { name: "Sumatera Utara Medan, Indonesia.", href: "#" },
  ],
  social: [
    {
      name: "Facebook",
...
export default function Example() {
  return (
    <footer className="bg-gray-100 border-t" aria-labelledby="footer-heading">
